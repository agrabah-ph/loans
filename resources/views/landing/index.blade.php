    ...
    <section class="banner-section" style="background-image: url('{{ asset('images/landing/featured-1.jpg') }}')">
        <div class="max-width">
            <div class="inside">
                ...
                <div class="description">The Philippines' leading loan aggregator platform focused on the agricultural value chain.</div>
        ...
        <div class="max-width padding">
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <h1 class="page-title">How to apply for a loan?</h1>
                    ...
                    <ul class="list">
                        ...
                        <li>
                            ...
                            <div class="content">
                                <b>Select Loan Product</b>
                                <p>You can filter and choose the best loan product on the Loan tab. By selecting apply, you may apply straight to the product you’ve chosen.</p>
                            </div>
                        </li>
                    </ul>
                </div>
