...
class ProductController extends Controller
{
    ...
    {
        $datas = Product::get();
        return response()->view('loan.product.index', compact('datas'));
    }
    ...
    {
        return response()->view('loan.product.create');
    }
...
//        return $data;
        if(auth()->user()->hasRole('super-admin')){
            return response()->view('loan.product.show', compact('data'));
        }
        return response()->view('loan.product.show', compact('data'));
    }
...
//        return $product->units;
        return view('loan.product.edit', compact('product'));
    }
