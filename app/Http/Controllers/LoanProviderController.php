...
//        return $datas;
        return response()->view('loan.loan-provider.index', compact('datas'));
...
//        return $loans;
            ...
            return view('loan.loan-provider.loans.index', compact('loans'));
        }
...
//                    $products = $data->product;
    ...
    public function customForms()
    {
        ...
        return view('loan.settings.forms.application-form');
    }
